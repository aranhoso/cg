...
function createPinwheelBlade(centerX, centerY, angle, length, width) {
    const vertices = [
        centerX, centerY, // centro pra animar dps
        
        centerX + Math.cos(angle) * length,
        centerY + Math.sin(angle) * length,
        
        centerX + Math.cos(angle - width) * (length * 0.3),
        centerY + Math.sin(angle - width) * (length * 0.3),
...
function mainPinwheel() {
    ...
    const stick = [
        -0.01, 0.1,   // top left
        -0.01, -0.6,  // bottom left
        0.01, 0.1,    // top right
        0.01, -0.6,   // bottom right
    ];
    ...
    const ground = [
        -1.0, -0.7,   // far left
        -1.0, -0.6,   // far left top
        1.0, -0.7,    // far right
        1.0, -0.6,    // far right top
    ];
